...
class LobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lobby" do
    assert_difference('Lobby.count') do
      post lobbies_url, params: { lobby: { applytime: @lobby.applytime, loginname: @lobby.loginname } }
    end
  ...
  test "should update lobby" do
    patch lobby_url(@lobby), params: { lobby: { applytime: @lobby.applytime, loginname: @lobby.loginname } }
